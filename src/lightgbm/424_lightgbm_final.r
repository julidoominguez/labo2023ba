...
PARAM$finalmodel$num_iterations <- 529
PARAM$finalmodel$learning_rate <- 0.0102631119815601
PARAM$finalmodel$feature_fraction <- 0.301470379617876
PARAM$finalmodel$min_data_in_leaf <- 197
